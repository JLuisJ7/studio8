			...
			<footer class="footer cf" role="contentinfo">
              ...
              <div class="textwidget">
                <span class='shortcode_social_icon_holder normal_social' >
                  <a href='https://plus.google.com/+SimonBouchard82/posts' target='_self'><i class='fa fa-google-plus  simple_social' style='font-size: 24px;'></i></a></span>
...
<span class='shortcode_social_icon_holder normal_social' ><a href='https://www.behance.net/simonbouchard' target='_self'><i class='fa fa-behance  simple_social' style='font-size: 24px;'></i></a></span></div>
    ...
    <div id="nav_menu-3" class="widget widget_nav_menu">
      <div class="menu-footer-navigation-container">
        <?php wp_nav_menu(array('theme_location' => 'menu-footer','menu_id' => 'menu', 'menu_class' => 'eleven columns','container' => '','items_wrap'      => '<ul id="menu-footer-navigation" class="menu">%3$s</ul>',)); ?>
      </div>
    </div>
    <div id="text-3" class="widget widget_text">
      <div class="textwidget">Handcrafted by <i class="fa fa-copyright"></i> <a href="http://themeforest.net/user/simonbouchard?ref=SimonBouchard" target="_blank" title="Simon Bouchard &mdash; Interactive Design" class="link by">Simon Bouchard</a>.</div>
		</div>
